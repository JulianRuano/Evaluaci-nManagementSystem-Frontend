...
const AssignLabourModal = ({
  ...
  let validLaboursForDocentType = []
  let uidAndLabourName = []

  if (data) {
    validLaboursForDocentType = getValidLaboursDocentType(data, docentType)
    uidAndLabourName = validLaboursForDocentType.map((labor) => ({
      uid: labor.uid,
